...
public class Constants {
	//IE驱动文件
	public static final String IE_DRIVER = "E:\\SoftwareInstall\\IEDriverServer.exe";
	//Chrome驱动文件
	public static final String CHROME_DRIVER = "E:\\SoftwareInstall\\chromedriver.exe";
	//隐式等待默认超时时间
	...
	public static final String SCREENSHOT = "C:\\Test\\Screenshot\\";
}
